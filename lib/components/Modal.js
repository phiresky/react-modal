...
var useReactPortal = _reactDom2.default.createPortal !== undefined;
...
var Modal = function (_Component) {
  ...
  function Modal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Modal.__proto__ || Object.getPrototypeOf(Modal)).call.apply(_ref, [this].concat(args))), _this), _this.portalRef = function (portal) {
      return _this.portal = portal;
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      if (useReactPortal && this.node) {
        return _reactDom2.default.createPortal(_react2.default.createElement(_ModalPortal2.default, _extends({ defaultStyles: Modal.defaultStyles, ref: this.portalRef }, this.props)), this.node);
      }
      return null;
    }
  }], [{
